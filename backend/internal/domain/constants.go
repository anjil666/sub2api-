...
var DefaultAntigravityModelMapping = map[string]string{
	...
	"claude-opus-4-6-thinking":   "claude-opus-4-7-thinking", // 迁移旧模型
	"claude-opus-4-6":            "claude-opus-4-7-thinking", // 迁移旧模型
	"claude-opus-4-5-thinking":   "claude-opus-4-7-thinking", // 迁移旧模型
