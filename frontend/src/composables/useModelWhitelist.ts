...
const antigravityPresetMappings = [
  ...
  { label: 'Opus→Opus', from: 'claude-opus-*', to: 'claude-opus-4-7-thinking', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
  ...
  { label: 'Opus4.5→4.7', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-7-thinking', color: 'bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-400' },
  // Gemini 3→3.1 映射
